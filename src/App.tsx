...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100 flex flex-col items-center justify-center p-8">
      ...
      <div className="mb-8">
        <div className="text-2xl text-center p-4 bg-amber-200/80 backdrop-blur-sm rounded-lg shadow-lg border-2 border-amber-400 flex flex-col items-center gap-2">
          <div>
          ...
          {gameEnded && (
            <div>
              <span className="font-bold text-amber-900">Result:</span>
              <span className={`font-bold ${score > 0 ? 'text-green-600' : score === 0 ? 'text-amber-500' : 'text-red-600'}`}>
